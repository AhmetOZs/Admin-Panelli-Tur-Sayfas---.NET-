...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Models.sınıflar.DetayGorselTR", b =>
                {
                    b.HasOne("WebApplication1.Models.sınıflar.TurlarTR", null)
                        .WithMany("detayGorsels")
                        .HasForeignKey("TurlarTRturID");
            ...
            modelBuilder.Entity("WebApplication1.Models.sınıflar.Turlar", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.sınıflar.bolgeTR", null)
                        .WithMany("Turlars")
                        .HasForeignKey("bolgeTRbolgeID");
            ...
            modelBuilder.Entity("WebApplication1.Models.sınıflar.TurlarTR", b =>
                {
                    b.HasOne("WebApplication1.Models.sınıflar.bolge", "Bolgetr")
                        .WithMany()
                        .HasForeignKey("bolgeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
